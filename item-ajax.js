$(document).ready(function(){
    ...
    function manageData(){
        $.ajax({
            ...
            $('#pagination').twbsPagination({
                ...
                onPageClick: function(even, pageL){
                    page = pageL;
                    if(is_ajax_fire !=0){
                        getPageData();
                    }
    ...
    function manageRow(data){
        ...
        $.each(data, function (key, value){
            ...
            rows = rows + '<button class="btn btn-danger remove-items">Delete</button>';
            rows = rows + '</tr>';
        });
        $("tbody").html(rows);
    }
    ...
    $("body").on("click",".remove-items",function(){
        ...
        $.ajax({
            ...
            c_obj.remove();
            toastr.success('Item Delete Succesfully','Success Alert',{timeOut:5000});
        });
    });
